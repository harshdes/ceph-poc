...
public class SwaggerConfig {
    ...
    @Bean
    public Docket FiosCephApi(SwaggerApiInfo swaggerApiInfo) {
        return new Docket(DocumentationType.SWAGGER_2)
                .useDefaultResponseMessages(false)
                .tags(new Tag("FIOS Ceph service", "Application for managing ceph cluster"))
                .alternateTypeRules(
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.wdc.fios"))
                .build();
    }
